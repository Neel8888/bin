...
function ProductTracker({url,setUrl}) {
    ...
    const trackData = async () => {
        setLoading(true);
        try {
            let trackUrl = `http://localhost:5000/scrape?url=${encodeURIComponent(url)}`
    ...
    return (
        <div className="product-tracker-container">
            ...
            <div className="input-section">
                ...
                <button onClick={trackData} disabled={loading}>Track</button>
            </div>
            {loading && <p>Loading...</p>}
            ...
            {data && (
                <div className="product-details">
                    ...
                    <div className="details-section">
                        ...
                        <p className="customer-ratings">Number of Ratings: {data.customer_ratings}</p>
                        <p className="number-of-reviews">Customer : {data.number_of_reviews}</p>
                    </div>
